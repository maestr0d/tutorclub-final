...
<div class="content2">
		<div class="registertitle2" style="background-color:#B3C100;">
			...
			<div class="linepad">
				...
				$sql="SELECT email FROM tbl_users ORDER BY id";
		...
		<div class="contpad">
			<div class="formcontainer">
				<div class="ffl">
					...
					<div class="fieldcont">
						...
						<input type="radio" class="rad" value="Thailand" id="thai" name="thaination"><label onclick="labelsel(this)" id="rthai" for="thai" class="radtext">Thai</label>
			...
			<div class="formcontainer">
				<div class="fieldcontl">
						<div class="textfieldcont" style="border-right:none;">About you:
						<div class="tooltip">*
						  <span class="tooltiptext">Required</span>
						</div>
						</div>
		...
		<div class="contpad">
			<div class="formcontainer">
				...
				<div class="fieldcontl">
					...
					<input type="url" class="fieldcontin2" class="phoneinp" name="website">
					<div style="clear:both"></div>
				</div>
			</div>
		</div>
		...
		<div class="contpad">
			<div class="formcontainer">
				...
				<div class="fieldcontl">
					<div class="textfieldconte">Years of study:
						<div class="tooltip">*
						  <span class="tooltiptext">Required</span>
						</div>
						</div>
		...
		<div class="contpad">
			<div class="formcontainer">
				...
				<div class="fieldcontl">
					...
					<select class="betweensel" id="yearswork" name="Wyearfrom">
					</select>
					<div class="radtextmin">to</div>
